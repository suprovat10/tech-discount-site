...
import { Tag, ArrowLeft, Plus, CheckCircle2 } from 'lucide-react';
import { Button } from '@/components/ui/button';
import { Input } from '@/components/ui/input';
import { CouponItem } from '@/data/coupons';
import { upsertCoupon } from '@/lib/couponStore';
    ...
    <div className="max-w-3xl mx-auto space-y-6">
      {savedSuccess && (
        <div className="p-4 bg-emerald-600 text-white font-bold text-xs flex items-center gap-2">
          ...
          <span>Coupon successfully created! Redirecting to coupon list...</span>
        </div>
      )}
      ...
      <form onSubmit={handleSubmit} className="border border-border bg-card p-6 space-y-4 text-xs">
        ...
        <div className="space-y-1.5">
          ...
          <textarea
            rows={2}
            placeholder="e.g. Use code at checkout for 20% discount on all eligible chargers."
            value={description}
