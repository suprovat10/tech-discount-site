...
export default function EditProductStudioPage({
  params,
}: {
  ...
  const handleRemoveFeature = (idx: number) => {
    ...
    if (editingFeatureIdx === idx) setEditingFeatureIdx(null);
  };
  ...
  const handleRemoveKeySpec = (idx: number) => {
    setKeySpecsList(keySpecsList.filter((_, i) => i !== idx));
    if (editingKeySpecIdx === idx) setEditingKeySpecIdx(null);
  };
  ...
  const handleRemoveSpec = (idx: number) => {
    ...
    if (editingSpecIdx === idx) setEditingSpecIdx(null);
  };
  ...
  const handleSetAsCover = (index: number) => {
    ...
    setImageAlts((prev) => {
      const selectedAlt = prev[index] || '';
      const oldCoverAlt = coverAlt;
      setCoverAlt(selectedAlt);
      const remaining = prev.filter((_, i) => i !== index);
  ...
  if (loading) {
    return <div className="p-8 text-center text-xs font-bold text-muted-foreground">Loading product data...</div>;
  }
    ...
    <div className="space-y-8 max-w-[1100px] pb-24">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground mt-0.5">
              Modify cover image, gallery, rich description, features, FAQs, real store links, and SEO settings.
            </p>
          </div>
        </div>
      ...
      {successToast && (
        <div className="p-4 border border-emerald-500 bg-emerald-50 dark:bg-emerald-950/40 text-emerald-800 dark:text-emerald-200 flex items-center gap-3 text-xs font-semibold">
          ...
          <span>Product updated successfully! Returning to inventory list...</span>
        </div>
      )}
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <section className="border border-border bg-card p-6 space-y-5">
          <div className="flex items-center gap-2 pb-3 border-b border-border">
            ...
            <div>
              ...
              <p className="text-[11px] text-muted-foreground">Title, brand, category, and rating indicators.</p>
            </div>
          </div>
        ...
        <section className="border border-border bg-card p-6 space-y-4">
          <div className="flex items-center gap-2 pb-3 border-b border-border">
            ...
            <div>
              ...
              <p className="text-[11px] text-muted-foreground">
                Edit font size, bold, italic, colors, and lists.
              </p>
            </div>
          </div>
          ...
          <RichTextEditor
            ...
            placeholder="Edit rich text product description..."
            minHeight="220px"
          />
        </section>
        ...
        <section className="border border-border bg-card p-6 space-y-4">
          <div className="flex items-center justify-between pb-3 border-b border-border">
            ...
            <span className="text-xs font-bold text-emerald-600">{features.length} Features</span>
          </div>
        ...
        <section className="border border-border bg-card p-6 space-y-4">
          <div className="flex items-center justify-between pb-3 border-b border-border">
            ...
            <span className="text-xs font-bold text-blue-600">{keySpecsList.length} Key Specs</span>
          </div>
        ...
        <section className="border border-border bg-card p-6 space-y-4">
          <div className="flex items-center justify-between pb-3 border-b border-border">
            ...
            <span className="text-xs font-bold text-amber-600">{specsList.length} Tech Specs</span>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-5 gap-2">
            <div className="sm:col-span-2">
              <Input
                placeholder="Spec Name (e.g. Storage, Processor)"
                value={newSpecKey}
            ...
            <div className="sm:col-span-2">
              <Input
                placeholder="Spec Value (e.g. 512GB SSD, Apple M3)"
                value={newSpecValue}
        ...
        <section className="border border-border bg-card p-6 space-y-4">
          <div className="flex items-center justify-between pb-3 border-b border-border">
            ...
            <span className="text-xs font-bold text-blue-600">{faqs.length} FAQs</span>
          </div>
        ...
        <section className="border border-border bg-card p-6 space-y-6">
          <div className="flex items-center justify-between pb-3 border-b border-border">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-[11px] text-muted-foreground">
                  Easily replace the cover photo or click &ldquo;Set as Cover&rdquo; on any gallery image.
                </p>
              </div>
            </div>
          ...
          {/* ALL GALLERY SLIDES WITH 'SET AS COVER' ACTION */}
            ...
            <div className="space-y-2">
              ...
              <div className="space-y-1.5">
                ...
                <div className="flex gap-2">
                  <Input
                    type="text"
                    placeholder="Slide SEO Alt text / keyword..."
                    value={newImageAlt}
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-3 border-b border-border">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-[11px] text-muted-foreground">
                  Amazon, Walmart, Best Buy, Target or ANY custom store / website with real-time price and custom shipping info.
                </p>
              </div>
            </div>
        ...
        <section className="border border-border bg-card p-6 space-y-6">
          <div className="flex items-center gap-2 pb-3 border-b border-border">
            ...
            <div>
              ...
              <p className="text-[11px] text-muted-foreground">Manage meta tags, canonical URL, and social share image.</p>
            </div>
          </div>
          ...
          <div className="space-y-4 text-xs">
            <div>
              <div className="flex items-center justify-between mb-1">
                ...
                <span className="text-[10px] text-muted-foreground font-semibold">{metaTitle.length} / 60</span>
              </div>
              <Input
                value={metaTitle}
            ...
            <div>
              <div className="flex items-center justify-between mb-1">
                ...
                <span className="text-[10px] text-muted-foreground font-semibold">{metaDescription.length} / 160</span>
              </div>
              <textarea
                rows={3}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label className="font-bold text-foreground block mb-1">Keywords</label>
                <Input
                  value={keywords}
