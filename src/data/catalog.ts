...
export const CATEGORIES: CategoryDefinition[] = [
  {
    ...
    subcategories: [
      { id: 'macbooks', name: 'MacBooks & Apple', slug: 'macbooks', imageUrl: '', showInTopSlider: true },
      { id: 'gaming-laptops', name: 'Gaming Laptops', slug: 'gaming-laptops', imageUrl: '', showInTopSlider: true },
      { id: 'ultrabooks', name: 'Ultrabooks & Windows', slug: 'ultrabooks', imageUrl: '' },
      { id: 'monitors', name: 'Monitors & Displays', slug: 'monitors', imageUrl: '' },
    ],
  },
  {
    id: 'audio-sound',
    ...
    showInTopSlider: true,
    subcategories: [
      { id: 'noise-canceling', name: 'Noise-Canceling', slug: 'noise-canceling', imageUrl: '', showInTopSlider: true },
      { id: 'wireless-earbuds', name: 'Wireless Earbuds', slug: 'wireless-earbuds', imageUrl: '', showInTopSlider: true },
      { id: 'soundbars', name: 'Soundbars & Home Audio', slug: 'soundbars', imageUrl: '' },
      { id: 'bluetooth-speakers', name: 'Bluetooth Speakers', slug: 'bluetooth-speakers', imageUrl: '' },
    ],
  },
  {
    ...
    showInTopSlider: true,
    subcategories: [
      { id: 'smartphones', name: 'Smartphones (iPhone & Android)', slug: 'smartphones', imageUrl: '', showInTopSlider: true },
      { id: 'smartwatches', name: 'Smartwatches & Fitness', slug: 'smartwatches', imageUrl: '', showInTopSlider: true },
      { id: 'tablets-ipads', name: 'Tablets & iPads', slug: 'tablets', imageUrl: '' },
    ],
  },
  {
    id: 'gaming-consoles',
    ...
    showInTopSlider: true,
    subcategories: [
      { id: 'playstation', name: 'PlayStation 5', slug: 'ps5', imageUrl: '', showInTopSlider: true },
      { id: 'xbox', name: 'Xbox Series X|S', slug: 'xbox', imageUrl: '' },
      { id: 'nintendo', name: 'Nintendo Switch', slug: 'nintendo', imageUrl: '' },
      { id: 'gaming-accessories', name: 'Controllers & Headsets', slug: 'gaming-gear', imageUrl: '' },
    ],
  },
  {
    id: 'tv-home-theater',
    ...
    showInTopSlider: true,
    subcategories: [
      { id: 'oled-tvs', name: 'OLED 4K TVs', slug: 'oled-tvs', imageUrl: '' },
      { id: 'qled-tvs', name: 'QLED & Mini-LED TVs', slug: 'qled-tvs', imageUrl: '' },
      { id: 'streaming-devices', name: 'Streaming Sticks & Boxes', slug: 'streaming', imageUrl: '' },
    ],
  },
  {
    id: 'cameras-drones',
    ...
    showInTopSlider: true,
    subcategories: [
      { id: 'mirrorless', name: 'Mirrorless Cameras', slug: 'mirrorless', imageUrl: '' },
      { id: 'action-cameras', name: 'Action & Dash Cams', slug: 'action-cams', imageUrl: '' },
      { id: 'smart-home', name: 'Smart Home & Security', slug: 'smart-home', imageUrl: '' },
    ],
  },
];
